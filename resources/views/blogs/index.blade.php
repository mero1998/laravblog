...
<div class="col-md-8 offset-md-2 text-center ">
    <h2><a href="{{ route('blogs.show' , [$blog->slug] ) }}">{{$blog->title}}</a></h2>
       <div class='col-md-12'>
            ...
            <img src="\public\images\featured_image/{{ $blog->featured_image ? $blog->featured_image : ''}}" alt='{{str_limit($blog->title , 50)}}' class='img-responsive featured_image' style="width:300px;height:auto"><br/>
            @endif
